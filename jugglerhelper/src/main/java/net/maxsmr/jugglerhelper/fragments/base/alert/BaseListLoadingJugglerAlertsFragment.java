...
import net.maxsmr.jugglerhelper.fragments.base.loading.BaseListLoadingJugglerFragment;


public abstract class BaseListLoadingJugglerAlertsFragment<I extends Comparable<I>, Adapter extends BaseRecyclerViewAdapter<I, ?>> extends BaseListLoadingJugglerFragment<I, Adapter> implements AlertDialogFragment.EventListener {
