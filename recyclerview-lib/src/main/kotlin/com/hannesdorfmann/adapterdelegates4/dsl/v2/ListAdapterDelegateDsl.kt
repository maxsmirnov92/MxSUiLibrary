package com.hannesdorfmann.adapterdelegates4.dsl.v2
 ...
 * @since 4.1.0
 */
inline fun <reified I : T, T, VH: AdapterDelegateViewHolder<I>> adapterDelegate(
    ...
    noinline createViewHolder: (View) -> VH,
    noinline block: VH.() -> Unit,
):  AbsListItemAdapterDelegate<T, T, VH> {
 ...
 * @since 4.1.0
 */
class DslListAdapterDelegate<I : T, T, VH : AdapterDelegateViewHolder<I>>(
    @LayoutRes private val layout: Int,
    private val on: (item: T, items: List<T>, position: Int) -> Boolean,
    private val initializerBlock: VH.() -> Unit,
    ...
    override fun onCreateViewHolder(parent: ViewGroup): VH =
        createViewHolder(layoutInflater(parent, layout)).also {
            initializerBlock(it)
        }
